...
**DoR has 9 checkpoints:** format, journey reference, acceptance criteria, visual reference, copy, observability signal, dependencies, size (1-3 days), tech feasibility.
