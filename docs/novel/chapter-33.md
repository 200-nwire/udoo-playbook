...
next:
  text: "Chapter 34 — Dina's Tuesday"
  link: '/novel/chapter-34'
---
...
**Eran:** Hey — quick question about the PR. In your implementation, what happens to an appointment that's scheduled for 2:30 AM on the night we change the clocks?
...
**Gal:** Oh. That time doesn't exist, does it. The clock goes from 2:00 to 3:00. So 2:30 is —

**Eran:** Yes. What does the system currently do with it?
...
**Gal:** I don't know. I'd have to test it.

**Eran:** Yes. What do you think the right behavior should be?
...
**Gal:** Probably surface it to the vet as a scheduling ambiguity. Not silently fail. Not silently succeed. Tell her there's a problem with this appointment and give her the option to move it.

**Eran:** Yes. Write the test for that. And write a comment in the code explaining why — not what the code does, why the behavior matters. So the next person who reads it knows.

**Gal:** The next person. Then: okay.
...
**Lior:** Different client. Different problem. Different team. A pause, then: Same first week.

**Eran:** What did you do differently?

**Lior:** Asked to watch someone work before we opened Jira.

**Eran:** Did they let you?
...
**Lior:** We found the thing in two hours that would have cost us three months. The project lead came with me. He didn't say much. On the way back he said — I've never done that before. I thought I knew what the client needed.

**Eran:** Did he?

**Lior:** He knew what the client said they needed. That's different.
