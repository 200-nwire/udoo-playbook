...
Prague, 2019. A conference on agile delivery — not the evangelical kind, not the kind where someone stands on a stage and tells you that everything you're doing is wrong and the answer is their certification program. The good kind. Small rooms. Practitioners talking to practitioners. The kind of conference where the best conversations happened in the corridor between sessions.

She found the notebook. A Moleskine, black, her handwriting in blue ink, neater in the morning sessions and progressively more telegraphic as the days went on.
...
And in the margin, smaller: Ask whether the retrospective changes anything. If the next sprint looks the same as the one before, it was therapy.

She closed the notebook.

Looked at the wall above her desk where she had, for reasons she no longer entirely remembered, pinned the velocity chart from the first eight sprints of the Kelev project. A line rising steadily from left to right. Twenty, twenty-two, twenty-four, twenty-six. The clean upward arc of a metric that was doing its job, which was to show improvement, which it was doing regardless of whether improvement was occurring.
...
She was beginning to understand that it was also, in certain configurations, a way of ensuring that the honesty arrived too late and too softened to change anything.

The appointment model. The timezone assumption. The forty-one bugs. Shira had found all of this in four hours. Michal had been on the project for eleven weeks.

She had known, in the way you know things you haven't examined, that the codebase had issues. She had seen the bug count growing. She had heard the conversations at the edges of standups — the half-sentences, the we'll need to look at that, the there's some stuff in the data model that's a bit — followed by the trailing off that she had, she now recognized, been too efficient at moving past.

She had maintained the motion. The motion had been maintained. The sprint had continued. The velocity had risen.
...
It was not a comfortable document. It was, she thought, the most honest thing she had written in this project. Which meant it was also the most useful.

She picked up her phone. Called Lior.

"I want to change how we run the retrospective on Friday," she said, when he answered.

"Okay," he said carefully.

"I want Shira to run it. And I want to use it as a diagnostic, not a therapy session." She paused. "I'll explain what I mean by that when we're in the room."

A silence.

"Michal," Lior said. "Are you okay?"

She thought about the question. The honest version of the answer was more complicated than the situation required.

"I'm recalibrating," she said. "I'll tell you about it sometime. Not now."
...
Then she opened the retrospective template and started rewriting it from the beginning.
